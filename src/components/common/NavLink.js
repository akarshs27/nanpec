...
import { ChevronDownIcon } from '@heroicons/react/solid'
 ...
 const NavLink = ({heading, options}) => {
  ...
  return (
    ...
    >
      <Menu.Items className="origin-top-right absolute right-0 mt-1 w-52 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
        <div className="py-1">
            {
                    options?.map((option) => (
                        <Menu.Item>
